...
linkedListParser dict key value = linkedListParser (myInsert dict (head key) (head value)) (tail key) (tail value)
hopeToGod = linkedListParser testDictLL testListKeys testListPair
